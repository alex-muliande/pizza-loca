$("input[name='status']").on("click", function() {
  $(".address").toggle(this.value == "200" && this.checked);
 });
//business logic
...
function quantity() {
  ...
  console.log(selectedQuantity);
function getSizeValue() {  var selectedValue = document.getElementById("pizzaSize").value;  return parseInt(selectedValue);}
